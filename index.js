  ...
  while (true) {
    try {
      ...
      if (page.url().includes('travel')) {
        ...
        // هـ) استنى 7 ثواني ثم انتقل للسوق الجديدة (بدون أي فحص يعيده للسوق القديم ويدخل في لوب)
        await sleep(7000);
      ...
      // لا يوجد أي معالجة للكولداون هنا، لأننا ننتظر السفر
      
      // ✅ كايرو
      if (state.loc === "Cairo") {
        // لو شاري حاجة غلط، ابيعها
