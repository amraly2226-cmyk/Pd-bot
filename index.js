    ...
    try {
      ...
      if (page.url().includes('travel')) {
        let currentCity = await page.evaluate(() => {
            ...
            if (m) return m[1];
            if (/Black Market - San Francisco/i.test(body)) return 'San Francisco';
            if (/Black Market - New York/i.test(body)) return 'New York';
            return null;
        });
      ...
      // ✅ نيويورك: بيع الإلكترونيكس أو شراء الأنابوليك
      ...
      // ✅ سان فرانسيسكو: بيع الأنابوليك، أو شراء الإلكترونيكس، أو السفر لنيويورك
