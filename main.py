...
# ═══════════════════════════════════════════════════════════════
# 📈 بوت الأسهم - نفس السكريبت اللي كان شغال بالظبط
# ═══════════════════════════════════════════════════════════════
    ...
    with sync_playwright() as p:
        ...
        while True:
            try:
                ...
                # دوس على SELL ALL اللي ظاهر في النافذة
                page.evaluate("""() => {
                ...
                print("⏳ [الأسهم] هستنى 15 دقيقة قبل الدورة الجاية...")
                sleep(900000)
